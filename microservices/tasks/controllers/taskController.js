...
exports.createTask = async (req, res, next) => {
  try {
    const { text, categoryId, priority, tags } = req.body;
    const newTask = await Task.create(text, categoryId, priority, tags);
...
exports.updateTask = async (req, res, next) => {
  try {
    ...
    const allowedFields = ['text', 'done', 'categoryId', 'priority', 'tags'];
